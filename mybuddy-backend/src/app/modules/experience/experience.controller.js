...
import {
  ...
  getSingleMemberExperienceService,
  updateExperienceService,
} from "./experience.service.js";

export const getSingleMemberExperienceController = catchAsync(
  async (req, res) => {
...
export const postSingleMemberExperienceController = catchAsync(
  async (req, res) => {
    const data = req.body;
