const InterestTab = () => {
  return (
    <div
      ...
      className="w-11/12 my-6 p-6 bg-[#d9e8f7] shadow-[-7px_-7px_19px_rgba(255,_255,_255,_0.6),_9px_9px_16px_rgba(163,_177,_198,_0.6)] box-border border-[0.8px] border-solid border-gray"
    >
