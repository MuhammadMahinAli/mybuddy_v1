...
const Projects = () => {
  ...
  return (
    <div className="relative -mt-8 md:-mt-7 lg:mt-0 3xl:-mt-6 mr-4 md:mr-0 lg:mr-0 xl:mr-0">
      ...
      <div className="flex flex-col sm:flex-row space-y-5 lg:space-y-0  md:space-x-7 lg:space-x-4 xl:space-x-2 3xl:space-x-2 md:items-center">
        {projects?.length > 0 ? (
              ...
              <div key={i}>
                ...
                >
                  ...
                  <div className="px-2 xs-2 ssm:pt-1 lg:pt-0 3xl:pt-6 xl:p-3  md:px-5 lg:py-3 space-y-1 lg:space-y-1">
                    <p className="lg:hidden text-xl 3xl:text-[22px] graish font-bold py-2 xs:py-3">
               ...
               w-full my-3 px-6 py-1 md:px-8 lg:px-3 md:py-2 text-[16px] md:text-xl lg:text-lg text-white font-semibold shadow-[0px_10px_10px_rgba(46,213,115,0.15)] rounded-[10px] [background:linear-gradient(-84.24deg,#2adba4,#76ffd4)]`}
                    >
                      View More
                    </button>
                  </div>
