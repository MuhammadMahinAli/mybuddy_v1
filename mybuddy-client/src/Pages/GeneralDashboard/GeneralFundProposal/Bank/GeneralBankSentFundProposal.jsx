...
const GeneralBankSentFundProposal = () => {
  const { getBankFundByRequestedBy } = useContext(AuthContext);
  ...
  const allSentFundRequest = getBankFundByRequestedBy?.data;
        ...
        <div className='w-[300px] xs:w-[330px] ssm:w-[370px] sm:w-[570px] md:w-[630px] lg:w-full overflow-x-auto xl:overflow-hidden'>
          ...
          {allSentFundRequest?.map((fundRqst, index) => (
            ...
            >
              ...
              <div onClick={() => handleOpenDetails(fundRqst)} className="cursor-pointer px-3 text-[16px] md:text-lg   border-r-2 border-white text-center w-2/12 lg:w-4/12">
                View Details
              </div>
...
export default GeneralBankSentFundProposal;
