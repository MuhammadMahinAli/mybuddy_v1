...
//       <p className="text-gray-600 text-[16px] lg:text-[24px] pb-5 font-medium text-center lg:text-start w-11/12 md:w-[600px] pt-7">{`You've not recieved any fund proposal yet.`}</p>
//    <div className="w-full py-4 bg-[#9ec9e2] flex my-5 items-center  shadow-[0px_4px_4px_rgba(255,_255,_255,_0.25),_-2px_-2px_20px_5px_rgba(255,_255,_255,_0.5),_-10px_-10px_55px_26px_rgba(255,_255,_255,_0.2),_17px_17px_38px_rgba(0,_0,_0,_0.31)] backdrop-filter:blur(20px); rounded-xl">
...
//       {/* table */}
//        <div className="w-full py-4 bg-[#9ec9e2] flex my-5 items-center  shadow-[0px_4px_4px_rgba(255,_255,_255,_0.25),_-2px_-2px_20px_5px_rgba(255,_255,_255,_0.5),_-10px_-10px_55px_26px_rgba(255,_255,_255,_0.2),_17px_17px_38px_rgba(0,_0,_0,_0.31)] backdrop-filter:blur(20px); rounded-xl">
//         <div className="flex flex-col md:flex-row justify-center items-center space-x-2 text-[16px] md:text-lg   border-r-2 border-white text-center w-4/12 md:w-3/12 lg:w-3/12">
//           <img
