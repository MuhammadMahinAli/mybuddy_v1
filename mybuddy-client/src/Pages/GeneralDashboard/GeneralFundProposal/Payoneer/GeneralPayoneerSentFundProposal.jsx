...
const GeneralPayoneerSentFundProposal = () => {
  const { getPayoneerFundByRequestedBy } = useContext(AuthContext);
  ...
  const allSentFundRequest = getPayoneerFundByRequestedBy?.data;   
    return (
        <div>
...
export default GeneralPayoneerSentFundProposal;
