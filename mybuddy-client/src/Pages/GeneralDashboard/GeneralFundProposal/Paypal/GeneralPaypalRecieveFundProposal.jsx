...
const GeneralPaypalRecieveFundProposal = () => {
  const { getPaypalFundByRequestedTo } = useContext(AuthContext);
  ...
  const allRecieveFundRequest = getPaypalFundByRequestedTo?.data;
  return (
    <div>
...
export default GeneralPaypalRecieveFundProposal;
