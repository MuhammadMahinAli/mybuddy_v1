...
const GeneralStripeRecieveFundProposal = () => {
  const { getFundByRequestedTo } = useContext(AuthContext);
...
export default GeneralStripeRecieveFundProposal;

// const GeneralStripeStripeRecieveFundProposal = () => {
//   return (
//     <div>
//       GeneralStripeStripeRecieveFundProposal
//     </div>
//   );
// };

// export default GeneralStripeStripeRecieveFundProposal;
