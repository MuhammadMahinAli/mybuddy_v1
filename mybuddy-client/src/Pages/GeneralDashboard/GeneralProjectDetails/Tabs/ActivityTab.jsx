...
const ActivityTab = ({ commits, getAllCommit, filteredMyself, formatDate, projectOwner,ProjectInfo,userId  }) => {
   //------------- get recieve project request
   const { data:   getCommitByProject} =
   useGetCommitByProjectQuery(ProjectInfo?._id);
      ...
      <div className="p-6 bg-gray-100 rounded-md">
        ...
        {commitOfProject?.map((commit, i) => (
          ...
          >
            ...
            <td className="px-4 py-4 text-gray-800">{formatDate(commit?.createdAt)}</td>
