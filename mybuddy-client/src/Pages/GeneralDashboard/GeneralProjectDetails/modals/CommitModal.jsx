              ...
              <Dialog.Panel className="w-full lg:w-9/12 transform overflow-hidden rounded-2xl bg-[#e9f2f9] p-6 text-left align-middle shadow-xl transition-all">
                <div className="px-[3px] rounded-m bg-[#e9f2f9]">
                  <div className={`graish`}>
                      ...
                      <div className="md:p-4 lg:p-6 3xl:p-10">
                        <form onSubmit={handleSubmit}>
                          <div className=" flex flex-col md:flex-row md:items-center justify-between  mb-4">
                            ...
                            <textarea
                              ...
                              className="md:w-10/12 p-3 border border-gray-200 rounded-md bg-[#e4ecf7] outline-none shadow-[-2px_-3px_9px_rgba(255,_255,_255,_0.88)_inset,_2px_3px_14px_#c7d3e1_inset]"
                          ...
                          <div className="flex flex-col md:flex-row md:items-center md:space-x-14 xl:space-x-[90px] 2xl:space-x-[97px] 3xl:space-x-[110px] 4xl:space-x-[120px] 5xl:space-x-[130px] 6xl:space-x-[170px] mb-4">
                            ...
                            >
                              ...
                              <span>
                                {formData?.media ? "Uploaded" : "Upload"}
                              </span>
                            </label>
                          </div>
                          <div className="flex flex-col md:flex-row md:items-center justify-between mb-4">
                          ...
                          <button
                            type="submit"
                            className="w-40 float-right bg-gradient-to-r [background:linear-gradient(-84.24deg,#2adba4,#76ffd4)] text-white py-1 md:py-3 px-2 rounded-md"
                          >
                            Upload Commit
                          </button>
                        </form>
