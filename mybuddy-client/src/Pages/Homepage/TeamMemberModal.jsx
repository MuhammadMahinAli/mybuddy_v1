...
const TeamMemberModal = ({
  ...
  const handleCheckboxChange = (id) => {
    setSelectedMembers((prevSelectedMembers) => {
      ...
      const updatedMembers = newSelectedMembers.map((memberId) => ({
        member: memberId,
      }));
                      ...
                      <div className="w-full px-3">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 lg:gap-8 pt-3">
                          ...
                          {currentFriend?.map((item, index) => {
                            ...
                            return (
                              <div
                                key={item?._id || index} // Use a fallback key if `_id` is unavailable
                                style={{
                                  backgroundColor:
