...
const DynamicProjectSkillSection = ({ theme, skillArray }) => {
  ...
  const allTechnologies = [
    ...
    { name: "Php", logo: phpLogo, bgColor: "#d2d3e6", lightButton: "#777BB3" },
    {
      name: "Postman",
      logo: postmanLogo,
      bgColor: "#fddac2",
    ...
    { name: "Go", logo: goLogo, bgColor: "#d0eafd", lightButton: "#588beb" },
    {
      name: "Perl",
      logo: perlLogo,
      bgColor: "#b8b8b8",
    ...
    { name: "Gcp", logo: gcpLogo, bgColor: "#b0d3e8", lightButton: "#0071b5" },
    {
      name: "Solr",
      logo: solrLogo,
      bgColor: "#fcdbd7",
    ...
    { name: "aws", logo: awsLogo, bgColor: "#fff4c6", lightButton: "#FF9900" },
    {
      name: "mongodb",
      logo: mongodbLogo,
      bgColor: "#c0e8d6",
        ...
        {userTechnologies?.map((tech, index) => (
          ...
          >
              ...
              <p
                ...
                } font-semibold text-sm md:text-[15px] capitalize`}
              >
                {tech.name}
              </p>
