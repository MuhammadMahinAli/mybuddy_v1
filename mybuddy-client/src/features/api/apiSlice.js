...
export const apiSlice = createApi({
  ...
  endpoints: (builder) => ({}),
  tagTypes: ["Memmer","Member","SingleMember","Post","SingleMemberPost","Friend","Fund","Project","ProjectJoinRequest","Payment","Skill","SingleMemberSkill","SocialInfo","SingleMemberSocialInfo","License","SingleMemberLicense","Experience","SingleMemberExperience","Commit","Meeting", "PostReact","Paypal","Payoneer","PaypalFund","PayoneerFund","BankTransferFund", "AdminBankInfo", "AdminTools","UserTools"],
});
